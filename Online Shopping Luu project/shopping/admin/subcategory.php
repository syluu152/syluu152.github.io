...
<head>
	...
	<title>Quản Lý Sub Category</title>
...
<div class="control-group">
<label class="control-label" for="basicinput"> Tên SubCategory</label>
<div class="controls">
<input type="text" placeholder="Nhập tên SubCategory"  name="subcategory" class="span8 tip" required>
</div>
</div>
