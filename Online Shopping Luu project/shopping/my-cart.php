...
?>
					...
					<td class="cart-product-sub-total"><span class="cart-sub-total-price"><?php echo " ".$row['productPrice'].".VND"; ?></span></td>
<td class="cart-product-sub-total"><span class="cart-sub-total-price"><?php echo " ".$row['shippingCharge']; ?>.VND</span></td>

					<td class="cart-product-grand-total"><span class="cart-grand-total-price"><?php echo ($_SESSION['cart'][$row['id']]['quantity']*$row['productPrice']+$row['shippingCharge']); ?>.VND</span></td>
				</tr>
...
<div class="form-group">
			 ...
			 <input type="text" class="form-control unicase-form-control text-input" id="shippingstate" name="shippingstate" value="<?php echo $row['shippingState'];?>" required>
					  ...
					  <div class="form-group">
					    <label class="info-title" for="Billing City">Thành Phố Giao Hàng <span>*</span></label>
			...
			<tr>
				<th>
					...
					<div class="cart-grand-total">
						Total:<span class="inner-left-md"><?php echo $_SESSION['tp']="$totalprice". ".00"; ?>.VND</span>
					</div>
				</th>
			</tr>
		</thead><!-- /thead -->
