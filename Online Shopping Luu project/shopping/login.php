...
<div class="col-md-6 col-sm-6 sign-in">
	<h4 class="">sign in</h4>
	<p class="">Hãy đăng nhập vào tài khoản của bạn để mua sắm.</p>
...
?>
		...
		<div class="radio outer-xs">
		  	<a href="forgot-password.php" class="forgot-password pull-right">Quên Mật Khẩu Của Bạn?</a>
		</div>
...
<div class="form-group">
	...
	<span class="checkout-subtitle outer-top-xs">Đăng Ký Ngay Hôm Nay Để:  </span>
	<div class="checkbox">
		...
		<label class="checkbox">
 Ghi Lại Tất Cả Các Giao Dịch Mua Bán Của Bạn.
		</label>
	</div>
</div>	
