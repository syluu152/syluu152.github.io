...
<div class="form-group">
					    <label class="info-title" for="name">Họ Tên Khách Hàng <span>*</span></label>
...
<div class="form-group">
			 ...
			 <input type="password" class="form-control unicase-form-control text-input" id="newpass" name="newpass">
					  ...
					  <button type="submit" name="submit" class="btn-upper btn btn-primary checkout-page-button">Đổi </button>
					</form> 
